export { default as PGPageContentAlert } from "./alertLists/alert/pg-page-content-alert";
...
export { default as PGPageContentVisData } from "./vis-data/pg-page-content-vis-data";
